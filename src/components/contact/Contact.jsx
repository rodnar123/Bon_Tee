  ...
  return (
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        <motion.h1 variants={variants}>About Us</motion.h1>
        <motion.div className="item">
          <h2>Mail</h2>
          <span>bonteesalez108405@gmail.com</span>
        </motion.div>
        <motion.div className="item">
          <h2>Address</h2>
          <span>C/-P.O BOX 688, PORT MORESBY,</span>
        </motion.div>
        <motion.div className="item">
          <h2>Phone</h2>
          <span>78808282</span>
      ...
      <div className="formContainer">
        ...
        >
          <svg width="600px" height="500px" viewBox="0 0 64 64">
